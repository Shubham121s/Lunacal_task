            ...
            {isAboutMeOpen ? (
              <>
                <div className="flex space-x-1 bg-[#2c2c2e] rounded-full p-1 w-max mb-4 shadow-inner">
                  <button className="px-4 py-2 bg-[#1c1c1e] rounded-full text-white font-medium shadow ">About Me</button>
                  <button className="px-4 py-2 text-[#8e8e93] hover:text-white transition-colors">Experiences</button>
                  <button className="px-4 py-2 text-[#8e8e93] hover:text-white transition-colors">Recommended</button>
                </div>
              ...
              <>
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <button onClick={handleAddImage} className="px-3 py-1 bg-[#4a4a4c] rounded-full text-white flex items-center space-x-1 hover:bg-[#5a5a5c] transition-colors shadow">
                      <Plus size={16} />
                      <span className="text-sm">ADD IMAGE</span>
                    </button>
                    <button className="p-2 bg-[#4a4a4c] rounded-full text-[#8e8e93] hover:bg-[#5a5a5c] transition-colors shadow" aria-label="Previous image">
                      <ChevronLeft size={20} />
                    </button>
                    <button className="p-2 bg-[#4a4a4c] rounded-full text-[#8e8e93] hover:bg-[#5a5a5c] transition-colors shadow" aria-label="Next image">
